...
## 0.2.6（2026-09-22）
### 🐛 修复
- 补齐所见即所得模式表格选区高亮与多单元格复制
- 修复待办项换行处悬空删除线与复选框变形
- 修复回车新建空待办项后光标贴着复选框且位置错误
### 📝 文档
- 新增依赖管理与升级策略规范

**完整对比**: [v0.2.5...v0.2.6](https://github.com/lvtian-bot/InkMark/compare/v0.2.5...v0.2.6)
## 0.2.5（2026-09-16）
### ♻️ 重构
- 换行解析、序列化与导出统一为宽松语义，删除严格模式分支
### ✨ 新增
- 新增排版数值设置（行距、段落间距、列表项间距），移除严格换行开关
### 🐛 修复
- 外部更新提示按钮文案改为重新加载
### 📝 文档
- 记录换行行为定稿与正文行距规格

**完整对比**: [v0.2.4...v0.2.5](https://github.com/lvtian-bot/InkMark/compare/v0.2.4...v0.2.5)
## 0.2.4（2026-09-13）
### ✨ 新增
- 宽档基准收紧至 1000px 并补充正文宽度设计文档
- 新增编辑区右键菜单与表格单元格内换行
### 📝 文档
- 补充外部改动审阅技术设计文档

**完整对比**: [v0.2.3...v0.2.4](https://github.com/lvtian-bot/InkMark/compare/v0.2.3...v0.2.4)
## 0.2.3（2026-09-12）
### ✨ 新增
- 收紧表格排版并支持宽表横向滚动
- 新增正文宽度设置（适中/宽/占满窗口）
- 简化外部审阅并修复进入时清空待审改动
### 🐛 修复
- 最近列表点击失效的文件或文件夹后自动清理该条目
- 新建文档首次保存后加入最近列表

**完整对比**: [v0.2.2...v0.2.3](https://github.com/lvtian-bot/InkMark/compare/v0.2.2...v0.2.3)
## 0.2.2（2026-09-12）
### ⚙️ 工程维护
- 应用图标替换为绿色 M 新设计
### ✨ 新增
...
**完整对比**: [v0.2.0...v0.2.1](https://github.com/lvtian-bot/InkMark/compare/v0.2.0...v0.2.1)
## 0.1.9（2026-08-22）
### ✨ 新增
