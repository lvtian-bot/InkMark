...
export const useStore = create<InkMarkState>((set, get) => ({
  ...
  setToolbarVisible: (visible) => {
    set(saveSettings({ ...selectSettings(get()), toolbarVisible: visible }));
  },
