...
export const messages: Record<MessageKey, string> = {
  ...
  'export.successBody': 'Exported to:\n{path}',
  'export.openFolder': 'Show in Folder',
  'export.failedTitle': 'Export Failed',
  'export.failedBody': 'Something went wrong while exporting the document. Please try again.',
  'export.inProgressHtml': 'Exporting HTML, please wait…',
  'export.inProgressPdf': 'Exporting PDF, please wait…',
  ...
  'settings.shortcuts.hint':
    'Click "Record", then press the combo (must include Ctrl or Cmd); Esc cancels. Formatting shortcuts may be left unset.',
  ...
  'settings.shortcuts.groupFormatting': 'Formatting',
  ...
  'shortcut.bulletList': 'Bullet List',
  'shortcut.taskList': 'Task List',
